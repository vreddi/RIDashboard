...
'''
Web Of Science can be accessed by the Library portal of UIUC. It is a paid resource, but
with a valid authentication an access is allowed. We would be Using wos.py as a API/ Library for
our needs for Citation Data
'''
